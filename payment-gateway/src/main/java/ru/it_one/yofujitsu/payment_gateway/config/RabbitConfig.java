package ru.it_one.yofujitsu.payment_gateway.config;
...
public class RabbitConfig {
    ...
    private String bankPaymentAuthorizationRequestQueue;
    ...
    @Bean
    public Queue paymentAuthRequestQueue() {
        var queue = new Queue(bankPaymentAuthorizationRequestQueue);
